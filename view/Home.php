                                ...
                                <div class="special-product-active owl-carousel">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img class= "image_name " src="images/product/large-size/1.jpg" alt="Li's Product Image">
                                                </a>
                                            ...
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <div class="price-box">
                                                        <span class="new-price price-amount">$46.80</span>
                                                    </div>
                                                ...
                                                <div class="add-actions">
                                                    <ul class="add-actions-link">
                                                        <li class="add-cart active cart"><a >Add to cart</a></li>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="single-product.html">
                                                    <img class="image_name" src="images/product/large-size/2.jpg" alt="Li's Product Image">
                                                </a>
                                                <span class="sticker">New</span>
                                            </div>
                                            <div class="product_desc">
                                                <div class="product_desc_info">
                                                    ...
                                                    <div class="price-box">
                                                        <span class="new-price new-price-2  price-amount">$71.80</span>
