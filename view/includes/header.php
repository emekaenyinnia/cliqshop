	...
	<![endif]-->
        ...
        <div class="body-wrapper">
            ...
            <header class="li-header-4">
                ...
                <div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0 header-sticky">
                    <div class="container">
                        <div class="row">
                                        ...
                                        <li class="hm-minicart">
                                            <div class="hm-minicart-trigger">
                                                ...
                                                <span class="item-text ">
                                                    <span class="cart-item-count numbers-of-cart">0</span>
                                                    <span  class="total-cart-amount"> </span>
                                                </span>
                                            </div>
                                            <span></span>
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        ...
                                                        <div class="minicart-product-details">
                                                            ...
                                                            <span>£80 <span class="multiple">x</span> <span class="numbersincart">1</span></span>
                                                        </div>
                                                        <button class="close">
                                                ...
                                                <p class="minicart-total">SUBTOTAL: <span class="totalamountofproducts"></span></p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu hb-menu-2 d-xl-block">
                                    <nav>
                                        <ul>
                                            <li class=""><a href="/view/home.php">Home</a>
                                            ...
                                            <li class="megamenu-static-holder pages-deck"><a href="index.html">Pages</a>
